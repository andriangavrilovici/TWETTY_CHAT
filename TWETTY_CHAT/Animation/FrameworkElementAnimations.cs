...
{
    /// <summary>
    /// Helpers to animate framework elements is specific ways
    /// </summary>
    public static class FrameworkElementAnimations
    {
        #region Slides In/Out
        /// <summary>
        ...
        /// <param name="size">The animation width to animate to. If not specified the elements size is used</param>
        /// <returns></returns>
        public static async Task SlideAndFadeInAsync(this FrameworkElement element, Direction direction, float seconds = 0.3f, bool keepMargin = true, int size = 0)
        {
        ...
        /// <param name="size">The animation width to animate to. If not specified the elements size is used</param>
        /// <returns></returns>
        public static async Task SlideAndFadeOutAsync(this FrameworkElement element, Direction direction, float seconds = 0.3f, bool keepMargin = true, int size = 0)
        {
            // Create the storyboard
            var sb = new Storyboard();
